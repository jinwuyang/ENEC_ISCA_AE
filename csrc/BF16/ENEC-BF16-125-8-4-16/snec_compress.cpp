...
public:
    ...
    __aicore__ inline void Process()
    {
        ...
        AIV_WITH_BARRIER(DataCopy, e_output1[write_offset], mergeLocal, cumulated_amount / 4);
...
private:
                                ...
                                )// 3， 6
    {
        ...
        if(cumulated_amount + outerNum >= computeNum){
            ...
            //         , 1, 32);
            // }
            AIV_WITH_BARRIER(DataCopy, e_output1[write_offset], mergeLocal, (computeNum / 4));
            write_offset = write_offset + computeNum / 4;
